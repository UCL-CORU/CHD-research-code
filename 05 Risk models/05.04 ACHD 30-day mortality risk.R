# 05.04 ACHD 30-DAY MORTALITY RISK
...
## input data: NCHDA processed data (files were generated in Step 07.03)
  ...
  in_file_name_ACHD_model <- "S://CHAMPION/Analysis/R script files/CHD code curation/07 Risk models/mapping files/ACHD_30d_mortality_model_coefficients.txt"
...
# 2. We format the numeric and flag fields (used in ACHD model)
  num_vars = c( "raop", "spgrp_death", "proc_complexity", "non_elective", "esccomplexity",
