...
Additional R code can be found in the [UCL CORU site](https://github.com/UCL-CORU/) for the [linkage of records using patient identifiers](https://github.com/UCL-CORU/LAUNCHESQI_Linkage) and for the [identification of pathways of care for sentinel diagnosis groups](https://github.com/UCL-CORU/CHAMPION-work-stream-2)
